...
public class MenuServiceImpl implements MenuService {
	...
	@Override
	public Menus parseMenuByPojo(PojoMenuDetail pojoMenuDetail) throws ShavikaAppException {
		...
		if (pojoMenuDetail.getMenutypeid() == 1) {
			...
			menus.setImage(Constants.NOT_APPLICABLE);
	...
	public PojoMenuDetail parseMenuByPojo(List<Menus> menuList) throws ShavikaAppException {
		...
		for (Menus menu : menuList) {
			...
			if (menu.getMenutypeid() == 1) {
				...
				pojoMenuDetail.setBfst_image(Constants.NOT_APPLICABLE);
				...
				pojoMenuDetail.setLuch_image(Constants.NOT_APPLICABLE);
				...
				pojoMenuDetail.setDinr_image(Constants.NOT_APPLICABLE);
			}
		}
